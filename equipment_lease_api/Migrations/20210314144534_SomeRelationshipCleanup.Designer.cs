...
namespace equipment_lease_api.Migrations
{
    ...
    [Migration("20210314144534_SomeRelationshipCleanup")]
    partial class SomeRelationshipCleanup
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("equipment_lease_api.Entities.AssetLeaseEntryUpdate", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("varchar(256)")
                    ...
                    b.ToTable("AssetLeaseEntryUpdates");
                });
            ...
            modelBuilder.Entity("equipment_lease_api.Entities.AssetLeaseEntryUpdate", b =>
                {
                    ...
                    b.HasOne("equipment_lease_api.Entities.LeaseInvoice", "LeaseInvoice")
                        .WithMany("AssetLeaseEntryUpdates")
